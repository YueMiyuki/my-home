...
export function Particles() {
  ...
  const createParticles = useCallback((count: number, canvas: HTMLCanvasElement): Particle[] => {
  ...
  const drawParticles = useCallback(
    (ctx: CanvasRenderingContext2D, particles: Particle[], canvas: HTMLCanvasElement, isDark: boolean) => {
